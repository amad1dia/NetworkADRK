...
class ActionBottomDialogFragment : BottomSheetDialogFragment(), View.OnClickListener {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.update_object_properties, container, false)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        view.findViewById<View>(R.id.update_color).setOnClickListener(this)
        view.findViewById<View>(R.id.update_label).setOnClickListener(this)
        view.findViewById<View>(R.id.remove_object).setOnClickListener(this)
    }
